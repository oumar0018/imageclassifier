...
def calculates_results_stats(results_dic):
    ...
    """        
    # Create the result dictionary as empty
    ...
    # Loop through the result dictionary and add values to the variables created above 
    for key in results_dic:
        # If pet image label matches the classifier label
        if results_dic[key][2] == 1:
            results_stats_dic['n_match'] += 1
            
            # Now check tosee if the pet image label indicate the image is a dog
